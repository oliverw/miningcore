...
namespace Miningcore.Tests.Crypto
{
    public class HashingTests : TestBase
    {
        ...
        public void Gr_Hash()
        {
            var hash = new byte[80] { 0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x1c,0xcc,0xa6,0x6a,0x44,0xf8,0xbd,0x55,0x45,0xc3,0x16,0x4a,0x3a,0x76,0xda,0x50,0x39,0x53,0x28,0xc9,0x07,0x56,0x33,0x77,0x5b,0xc4,0xc8,0x79,0x8f,0xd6,0x77,0x2b,0x70,0x0d,0x21,0x5c,0xf0,0xff,0x0f,0x1e,0x00,0x00,0x00,0x00 };
            var hasher = new GR();
            hasher.Digest(testValue, hash);
            var result = hash.ToHexString();

            Assert.Equal("38a26c33e464c30b0720362ca2f27edd4e4c2958cd26d9dd4db86e6bd8d79172", result);
        }
    }
}
