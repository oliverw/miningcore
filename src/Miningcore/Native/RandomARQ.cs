...
public static unsafe class RandomARQ
{
    ...
    private static extern IntPtr randomx_alloc_cache(RandomX.randomx_flags flags);
    ...
    private static extern IntPtr randomx_alloc_dataset(RandomX.randomx_flags flags);
    ...
    private static extern IntPtr randomx_create_vm(RandomX.randomx_flags flags, IntPtr cache, IntPtr dataset);
    ...
    public class RxDataSet : IDisposable
    {
        ...
        public IntPtr Init(ReadOnlySpan<byte> key, RandomX.randomx_flags flags, IntPtr cache)
        {
