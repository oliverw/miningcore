...
export HAVE_FEATURE="$(../Native/check_cpu.sh sse2 && echo -D=HAVE_SSE2 || echo) $(../Native/check_cpu.sh ssse3 && echo -D=HAVE_SSSE3 || echo) $(../Native/check_cpu.sh avx && echo -D=HAVE_AVX || echo) $(../Native/check_cpu.sh avx2 && echo -D=HAVE_AVX2 || echo) $(../Native/check_cpu.sh avx512f && echo -D=HAVE_AVX512F || echo)"
