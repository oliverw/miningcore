    ...
    public class StatsRepository : IStatsRepository
    {
		    ...
		    BlockchainStats blockchainStats)
	    {
			...
			var query = "INSERT INTO poolstats(poolid, lastpoolblocktime, connectedminers, poolhashrate, " +
		                "poolfeepercent, donationspercent, averageresponsetimeperminutems, sharespersecond, " +
		                ...
		                "averageresponsetimeperminutems = @averageresponsetimeperminutems, sharespersecond = @sharespersecond, " +
