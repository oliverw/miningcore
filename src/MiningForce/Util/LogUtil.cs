...
namespace MiningForce.Util
{
    public static class LogUtil
    {
	    ...
	    public static void LogThrowPoolStartupException(this ILogger logger, string msg, string category = null)
	    {
	    ...
	    public static void LogThrowPoolStartupException(this ILogger logger, Exception ex, string msg, string category = null)
	    {
		    var output = !string.IsNullOrEmpty(category) ? $"[{category}] {msg}" : msg;
